...
function rebuildClients() {
  ...
  agentA = new AgentClient({ ip: a.ip || '127.0.0.1', port: a.port || 18789, token: a.token || '', agentId: a.agentId || 'main', relayPort: a.relayPort || 3001 })
  agentB = new AgentClient({ ip: b.ip || '127.0.0.1', port: b.port || 18789, token: b.token || '', agentId: b.agentId || 'main', relayPort: b.relayPort || 3001 })
}
